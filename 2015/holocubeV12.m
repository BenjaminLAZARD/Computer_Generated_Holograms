...
%Dernia¨re version du code pour generer un cube avec les masques.
%Pour obtenir un cube de référence, avec des paramètres intéressants, utiliser : holocubeV12(0.5,770,0.6,24000,0,0,30,0).

function [ image ] = holocubeV12(R,d,v,w,x0,y0,a0,j)
...
stra0 = num2str(a0);
strj = num2str(j);
str = strcat('CubeV12,R=',strR,',d=',strd,',v=',strv,',w=',strw,',x0=',strx0,',y0=',stry0,',a0=',stra0,',j=',strj,'.bmp');   %nom de l'image creee actualise en fonction des constantes
