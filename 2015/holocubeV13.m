...
%Pour obtenir un cube de référence, avec des paramètres intéressants, utiliser : holocubeV9(0.5,400,0.6,20000,0,0,30,0).

function [ image ] = holocubeV13(R,d,v,w,x0,y0,a0)
...
stra0 = num2str(a0);
strj = num2str(j);
str = strcat('CubeV13,R=',strR,',d=',strd,',v=',strv,',w=',strw,',x0=',strx0,',y0=',stry0,',a0=',stra0,'.bmp');   %nom de l'image creee actualise en fonction des constantes
