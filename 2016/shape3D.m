...
%* *rot*=['axis','phi'] où axis est dans {'x','y','z'} et phi est un angle en radian. Cela permet de changer l'angle de vue de la figure par une rotration de phi autour de l'axe sélectionné.
...
rot=['x','0'];%il faudrait en fait que rot soit un argument de la fonction, mais nous n'avons pas encore intégré cela au programme.
