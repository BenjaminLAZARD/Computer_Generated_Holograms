...
%Il ne s'agit pas de la dernière version.
%Pour obtenir un cube de référence, avec des paramètres intéressants, utiliser : holocubeV11(0.5,770,0.6,24000,0,0,0).

function [ image ] = holocubeV11(R,d,v,w,x0,y0,j)
...
for m=-960:1:959
	%amplitude(1:1080,m+961)=amplitude(1:1080,m+961) + exp(i*2*pi*m*pas_pixel*sin(j)/lambda);  %angle d'attaque de j.
...
stry0 = num2str(y0);
strj = num2str(j);
str = strcat('CubeV11,R=',strR,',d=',strd,',v=',strv,',w=',strw,',x0=',strx0,',y0=',stry0,',j=',strj,'.bmp');   %nom de l'image creee actualise en fonction des constantes
