...
%Cette version implémente un filtre passe haut (necessite madct.m,
%madct2.m, imadct.m, imadct2.m, filtre_passe_haut.
%Pour obtenir un cube de référence, avec des paramètres intéressants, utiliser : holocubeV10(0.5,770,0.6,24000,120,20).

function [ image ] = holocubeV10(R,d,v,w,x0,y0,na,ma)
...
strna = num2str(na);
strma = num2str(ma);
str = strcat('CubeV10,R=',strR,',d=',strd,',v=',strv,',w=',strw,',x0=',strx0,',y0=',stry0,',na=',strna,',ma=',strma,'.bmp');   %nom de l'image creee actualise en fonction des constantes


%Partie filtrage passe-haut
image=filtre_passe_haut(image,na,ma);
