...
%Version permettant de remplir la face avant du cube, de préférence
%utiliser la version V14
%Pour obtenir un cube de référence, avec des paramètres intéressants, utiliser : holocubeV9(0.5,770,0.6,24000,0,0,1,0).

function [ image ] = face_avant_pleine(R,d,v,w,x0,y0,a0,j,na,ma)
...
strna = num2str(na);
strma = num2str(ma);
str = strcat('face_avant_pleine,R=',strR,',d=',strd,',v=',strv,',w=',strw,',x0=',strx0,',y0=',stry0,',a0=',stra0,',j=',strj,',na=',strna,',ma=',strma,'.bmp');   %nom de l'image creee actualise en fonction des constantes
